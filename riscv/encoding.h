...
#define MATCH_BARRIER 0x200200b
#define MASK_BARRIER  0xfe00707f
#define MATCH_VBEQ 0xb
#define MASK_VBEQ  0x707f
#define MATCH_VBNE 0x100b
#define MASK_VBNE  0x707f
#define MATCH_VBLT 0x400b
#define MASK_VBLT  0x707f
#define MATCH_VBGE 0x500b
#define MASK_VBGE  0x707f
#define MATCH_VBLTU 0x600b
#define MASK_VBLTU  0x707f
#define MATCH_VBGEU 0x700b

...
#define MATCH_SHUFFLE_IDX 0x26001042
#define MASK_SHUFFLE_IDX 0xfe00707f
#define MATCH_SHUFFLE_UP 0x2a001042
#define MASK_SHUFFLE_UP 0xfe00707f
#define MATCH_SHUFFLE_DOWN 0x2e001042
#define MASK_SHUFFLE_DOWN 0xfe00707f
#define MATCH_SHUFFLE_BFLY 0x22001042
#define MASK_SHUFFLE_BFLY 0xfe00707f
#define MATCH_MMA_M8N8K16 0x0000000a
#define MASK_MMA_M8N8K16 0x0e00007f
#define MATCH_MMA_M16N8K16 0x0200000a
#define MASK_MMA_M16N8K16 0x0e00007f
#define MATCH_MMA_M8N16K16 0x0400000a
#define MASK_MMA_M8N16K16 0x0e00007f
#define MATCH_MMA_M16N16K16 0x0600000a
#define MASK_MMA_M16N16K16 0x0e00007f
#define MATCH_MMA_M8N8K8 0x0800000a
#define MASK_MMA_M8N8K8 0x0e00007f
#define MATCH_MMA_M16N8K8 0x0a00000a
#define MASK_MMA_M16N8K8 0x0e00007f
#define MATCH_MMA_M8N16K8 0x0c00000a
#define MASK_MMA_M8N16K8 0x0e00007f
#define MATCH_MMA_M16N16K8 0x0e00000a
#define MASK_MMA_M16N16K8 0x0e00007f
#define MATCH_VT_RT_TRAVERSE 0xe200000a
#define MASK_VT_RT_TRAVERSE 0xfe00707f
#define MATCH_VT_RT_RELEASE 0xe200100a
...
#define MATCH_VMUL_F16X2 0x0600005a
#define MASK_VMUL_F16X2 0xfe00707f
#define MATCH_VFMA_F16X2 0x0a00005a
#define MASK_VFMA_F16X2 0xfe00707f
#define MATCH_VADD_BF16X2 0x0200105a
#define MASK_VADD_BF16X2 0xfe00707f
#define MATCH_VMUL_BF16X2 0x0600105a
#define MASK_VMUL_BF16X2 0xfe00707f
#define MATCH_VFMA_BF16X2 0x0a00105a
#define MASK_VFMA_BF16X2 0xfe00707f
#define MATCH_VCVT_FP32_FP16 0x0200007a
#define MASK_VCVT_FP32_FP16 0xfe0ff07f
#define MATCH_VCVT_FP16_FP32 0x0600007a
#define MASK_VCVT_FP16_FP32 0xfe0ff07f
#define MATCH_VCVT_FP32_BF16 0x0a00007a
#define MASK_VCVT_FP32_BF16 0xfe0ff07f
#define MATCH_VCVT_BF16_FP32 0x0e00007a
#define MASK_VCVT_BF16_FP32 0xfe0ff07f
#define MATCH_VEX2_APPROX_F32 0x0200002a
#define MASK_VEX2_APPROX_F32 0xfe0ff07f
#define MATCH_VLG2_APPROX_F32 0x0600002a
#define MASK_VLG2_APPROX_F32 0xfe0ff07f
#define MATCH_VRCP_APPROX_F32 0x0a00002a
#define MASK_VRCP_APPROX_F32 0xfe0ff07f
#define MATCH_VSQRT_APPROX_F32 0x0e00002a
#define MASK_VSQRT_APPROX_F32 0xfe0ff07f
#define MATCH_VRSQRT_APPROX_F32 0x1200002a
#define MASK_VRSQRT_APPROX_F32 0xfe0ff07f
#define MATCH_VSIN_APPROX_F32 0x1600002a
#define MASK_VSIN_APPROX_F32 0xfe0ff07f
#define MATCH_VCOS_APPROX_F32 0x1a00002a
#define MASK_VCOS_APPROX_F32 0xfe0ff07f
#define MATCH_VTANH_APPROX_F32 0x1e00002a
#define MASK_VTANH_APPROX_F32 0xfe0ff07f
#define MATCH_VGELU_APPROX_F32 0x2200002a
#define MASK_VGELU_APPROX_F32 0xfe0ff07f
#define MATCH_VSILU_APPROX_F32 0x2600002a
#define MASK_VSILU_APPROX_F32 0xfe0ff07f
#define MATCH_VEX2_APPROX_F16X2 0x0200102a
#define MASK_VEX2_APPROX_F16X2 0xfe0ff07f
#define MATCH_VRCP_APPROX_F16X2 0x0a00102a
#define MASK_VRCP_APPROX_F16X2 0xfe0ff07f
#define MATCH_VSQRT_APPROX_F16X2 0x0e00102a
#define MASK_VSQRT_APPROX_F16X2 0xfe0ff07f
#define MATCH_VRSQRT_APPROX_F16X2 0x1200102a
#define MASK_VRSQRT_APPROX_F16X2 0xfe0ff07f
#define MATCH_VTANH_APPROX_F16X2 0x1e00102a
#define MASK_VTANH_APPROX_F16X2 0xfe0ff07f
#define MATCH_VGELU_APPROX_F16X2 0x2200102a
#define MASK_VGELU_APPROX_F16X2 0xfe0ff07f
#define MATCH_VSILU_APPROX_F16X2 0x2600102a
#define MASK_VSILU_APPROX_F16X2 0xfe0ff07f
#define MATCH_VEX2_APPROX_BF16X2 0x0200202a
#define MASK_VEX2_APPROX_BF16X2 0xfe0ff07f
#define MATCH_VRCP_APPROX_BF16X2 0x0a00202a
#define MASK_VRCP_APPROX_BF16X2 0xfe0ff07f
#define MATCH_VSQRT_APPROX_BF16X2 0x0e00202a
#define MASK_VSQRT_APPROX_BF16X2 0xfe0ff07f
#define MATCH_VRSQRT_APPROX_BF16X2 0x1200202a
#define MASK_VRSQRT_APPROX_BF16X2 0xfe0ff07f
#define MATCH_VTANH_APPROX_BF16X2 0x1e00202a
#define MASK_VTANH_APPROX_BF16X2 0xfe0ff07f
#define MATCH_VGELU_APPROX_BF16X2 0x2200202a
#define MASK_VGELU_APPROX_BF16X2 0xfe0ff07f
#define MATCH_VSILU_APPROX_BF16X2 0x2600202a
#define MASK_VSILU_APPROX_BF16X2 0xfe0ff07f
...
DECLARE_INSN(shuffle_idx, MATCH_SHUFFLE_IDX, MASK_SHUFFLE_IDX)
DECLARE_INSN(shuffle_up, MATCH_SHUFFLE_UP, MASK_SHUFFLE_UP)
DECLARE_INSN(shuffle_down, MATCH_SHUFFLE_DOWN, MASK_SHUFFLE_DOWN)
DECLARE_INSN(shuffle_bfly, MATCH_SHUFFLE_BFLY, MASK_SHUFFLE_BFLY)
DECLARE_INSN(mma_m8n8k16, MATCH_MMA_M8N8K16, MASK_MMA_M8N8K16)
DECLARE_INSN(mma_m16n8k16, MATCH_MMA_M16N8K16, MASK_MMA_M16N8K16)
DECLARE_INSN(mma_m8n16k16, MATCH_MMA_M8N16K16, MASK_MMA_M8N16K16)
DECLARE_INSN(mma_m16n16k16, MATCH_MMA_M16N16K16, MASK_MMA_M16N16K16)
DECLARE_INSN(mma_m8n8k8, MATCH_MMA_M8N8K8, MASK_MMA_M8N8K8)
DECLARE_INSN(mma_m16n8k8, MATCH_MMA_M16N8K8, MASK_MMA_M16N8K8)
DECLARE_INSN(mma_m8n16k8, MATCH_MMA_M8N16K8, MASK_MMA_M8N16K8)
DECLARE_INSN(mma_m16n16k8, MATCH_MMA_M16N16K8, MASK_MMA_M16N16K8)
DECLARE_INSN(vt_rt_traverse, MATCH_VT_RT_TRAVERSE, MASK_VT_RT_TRAVERSE)
DECLARE_INSN(vt_rt_release, MATCH_VT_RT_RELEASE, MASK_VT_RT_RELEASE)
DECLARE_INSN(vt_rt_enqueue, MATCH_VT_RT_ENQUEUE, MASK_VT_RT_ENQUEUE)
DECLARE_INSN(vlrt_w, MATCH_VLRT_W, MASK_VLRT_W)
DECLARE_INSN(vsrt_w, MATCH_VSRT_W, MASK_VSRT_W)
DECLARE_INSN(vadd_f16x2, MATCH_VADD_F16X2, MASK_VADD_F16X2)
DECLARE_INSN(vmul_f16x2, MATCH_VMUL_F16X2, MASK_VMUL_F16X2)
DECLARE_INSN(vfma_f16x2, MATCH_VFMA_F16X2, MASK_VFMA_F16X2)
DECLARE_INSN(vadd_bf16x2, MATCH_VADD_BF16X2, MASK_VADD_BF16X2)
DECLARE_INSN(vmul_bf16x2, MATCH_VMUL_BF16X2, MASK_VMUL_BF16X2)
DECLARE_INSN(vfma_bf16x2, MATCH_VFMA_BF16X2, MASK_VFMA_BF16X2)
DECLARE_INSN(vcvt_fp32_fp16, MATCH_VCVT_FP32_FP16, MASK_VCVT_FP32_FP16)
DECLARE_INSN(vcvt_fp16_fp32, MATCH_VCVT_FP16_FP32, MASK_VCVT_FP16_FP32)
DECLARE_INSN(vcvt_fp32_bf16, MATCH_VCVT_FP32_BF16, MASK_VCVT_FP32_BF16)
DECLARE_INSN(vcvt_bf16_fp32, MATCH_VCVT_BF16_FP32, MASK_VCVT_BF16_FP32)
DECLARE_INSN(vex2_approx_f32, MATCH_VEX2_APPROX_F32, MASK_VEX2_APPROX_F32)
DECLARE_INSN(vlg2_approx_f32, MATCH_VLG2_APPROX_F32, MASK_VLG2_APPROX_F32)
DECLARE_INSN(vrcp_approx_f32, MATCH_VRCP_APPROX_F32, MASK_VRCP_APPROX_F32)
DECLARE_INSN(vsqrt_approx_f32, MATCH_VSQRT_APPROX_F32, MASK_VSQRT_APPROX_F32)
DECLARE_INSN(vrsqrt_approx_f32, MATCH_VRSQRT_APPROX_F32, MASK_VRSQRT_APPROX_F32)
DECLARE_INSN(vsin_approx_f32, MATCH_VSIN_APPROX_F32, MASK_VSIN_APPROX_F32)
DECLARE_INSN(vcos_approx_f32, MATCH_VCOS_APPROX_F32, MASK_VCOS_APPROX_F32)
DECLARE_INSN(vtanh_approx_f32, MATCH_VTANH_APPROX_F32, MASK_VTANH_APPROX_F32)
DECLARE_INSN(vgelu_approx_f32, MATCH_VGELU_APPROX_F32, MASK_VGELU_APPROX_F32)
DECLARE_INSN(vsilu_approx_f32, MATCH_VSILU_APPROX_F32, MASK_VSILU_APPROX_F32)
DECLARE_INSN(vex2_approx_f16x2, MATCH_VEX2_APPROX_F16X2, MASK_VEX2_APPROX_F16X2)
DECLARE_INSN(vrcp_approx_f16x2, MATCH_VRCP_APPROX_F16X2, MASK_VRCP_APPROX_F16X2)
DECLARE_INSN(vsqrt_approx_f16x2, MATCH_VSQRT_APPROX_F16X2, MASK_VSQRT_APPROX_F16X2)
DECLARE_INSN(vrsqrt_approx_f16x2, MATCH_VRSQRT_APPROX_F16X2, MASK_VRSQRT_APPROX_F16X2)
DECLARE_INSN(vtanh_approx_f16x2, MATCH_VTANH_APPROX_F16X2, MASK_VTANH_APPROX_F16X2)
DECLARE_INSN(vgelu_approx_f16x2, MATCH_VGELU_APPROX_F16X2, MASK_VGELU_APPROX_F16X2)
DECLARE_INSN(vsilu_approx_f16x2, MATCH_VSILU_APPROX_F16X2, MASK_VSILU_APPROX_F16X2)
DECLARE_INSN(vex2_approx_bf16x2, MATCH_VEX2_APPROX_BF16X2, MASK_VEX2_APPROX_BF16X2)
DECLARE_INSN(vrcp_approx_bf16x2, MATCH_VRCP_APPROX_BF16X2, MASK_VRCP_APPROX_BF16X2)
DECLARE_INSN(vsqrt_approx_bf16x2, MATCH_VSQRT_APPROX_BF16X2, MASK_VSQRT_APPROX_BF16X2)
DECLARE_INSN(vrsqrt_approx_bf16x2, MATCH_VRSQRT_APPROX_BF16X2, MASK_VRSQRT_APPROX_BF16X2)
DECLARE_INSN(vtanh_approx_bf16x2, MATCH_VTANH_APPROX_BF16X2, MASK_VTANH_APPROX_BF16X2)
DECLARE_INSN(vgelu_approx_bf16x2, MATCH_VGELU_APPROX_BF16X2, MASK_VGELU_APPROX_BF16X2)
DECLARE_INSN(vsilu_approx_bf16x2, MATCH_VSILU_APPROX_BF16X2, MASK_VSILU_APPROX_BF16X2)
